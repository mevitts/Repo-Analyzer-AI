...
4.  Your final action **MUST** be to call the `save_selected_files` tool, passing the list of file paths you have chosen as the 'files' argument.

**CRITICAL:** Do not respond with text. Your only goal is to complete the workflow and call the `save_selected_files` tool.
"""
